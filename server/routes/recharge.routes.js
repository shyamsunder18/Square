...
// Get UPI information (admin only)
router.get('/upi-info', authMiddleware, async (req, res) => {
  try {
...
router.post('/approve/:userId/:rechargeId', authMiddleware, adminMiddleware, async (req, res) => {
  try {
...
router.post('/reject/:userId/:rechargeId', authMiddleware, adminMiddleware, async (req, res) => {
  try {
    const { userId, rechargeId } = req.params;
    const user = await User.findById(userId);
...
router.post('/update-upi-info', authMiddleware, adminMiddleware, async (req, res) => {
  try {
